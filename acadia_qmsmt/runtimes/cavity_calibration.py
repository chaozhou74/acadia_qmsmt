...
class CavityCalibrationRuntime(QMsmtRuntime):
    ...
    qubit_saturation_pulse: dict[str,float] = {"length": 100e-9, "fixed_length": 5e-6}
    ...
    def main(self):
        ...
        def sequence(a: Acadia):
            ...
            with a.channel_synchronizer():
                ...
                a.barrier()
                qubit.pulse(qubit_saturation_pulse)
                a.barrier()
        ...
        qubit_saturation_pulse.set("hann", scale=self.qubit_saturation_pulse.get("scale", 1.0))
        ...
        for i in range(self.iterations):
            for cavity_pulse_amplitude in self.cavity_pulse_amplitudes:
                ...
                for qubit_frequency in self.qubit_frequencies:
                    ...
                    self.acadia.run(minimum_delay=5000000)
    ...
    def update(self):
        ...
        for idx_amp,_ in enumerate(self.cavity_pulse_amplitudes):
            self.line_pops[idx_amp].update(self.qubit_frequencies, avg[idx_amp,:], rescale_axis=False)
