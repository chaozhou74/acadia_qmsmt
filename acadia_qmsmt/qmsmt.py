...
class Qubit:
    ...
    def make_tomo_pulses(self, qubit_pi_pulse_name:str, symmetrize:bool=True):
        """
    ...
    def n_mode_tomo(self, tomo_cache, state_mapping_fns:List[callable], qubit_pi_pulse_name:str,
        ...
        self.make_tomo_pulses(qubit_pi_pulse_name, symmetrize)
...
def load_tomo_pulses(qubits:List[Qubit]):
    """
    Load tomography pulses that were generated by :meth:`qubit.make_tomo_pulses`
...
def n_qubit_tomo(qubits: List[Qubit], tomo_cache, core:callable, qubit_pi_pulse_names:List[str], 
    ...
    for i in range(num_qubits):
        qubits[i].make_tomo_pulses(qubit_pi_pulse_names[i], symmetrize)
